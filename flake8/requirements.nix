...
let
  ...
  generated = self: {
    ...
    "flake8-builtins" = python.mkDerivation {
      name = "flake8-builtins-1.3.0";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/85/5c/45a279fe286e9c4df1644a5351af8c0f931e104fa2e4749e7eaeae8b5376/flake8-builtins-1.3.0.tar.gz"; sha256 = "ede1673c45ff967aea782231ae4836072a58a5f9db7700cf531995c76ba1734b"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."flake8"
    ...
    "flake8-ownership" = python.mkDerivation {
      ...
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/bf/28/dfa5aeffd57856e81f59169eb36d426b41322ae4e4d5e40b34a3cdc50423/flake8-ownership-1.1.1.tar.gz"; sha256 = "608db36fb4395afed91ddb5d358b5a1fabcb0fe55ac9214c30808374aece1d88"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."flake8"
    ...
    "testfixtures" = python.mkDerivation {
      ...
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/b1/87/1f3e43248af711f09faf05854b4af10a20e9b8c9dc66f500690c5d928bfb/testfixtures-6.0.0.tar.gz"; sha256 = "f6c4cf24d043f9d8e9a9337371ec1d2f6638a0032504bd67dbd724224fd64969"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [ ];
      meta = with pkgs.stdenv.lib; {
