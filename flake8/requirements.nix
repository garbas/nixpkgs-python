...
let
  ...
  generated = self: {
    ...
    "flake8-builtins" = python.mkDerivation {
      ...
      src = pkgs.fetchurl { url = "https://pypi.python.org/packages/85/5c/45a279fe286e9c4df1644a5351af8c0f931e104fa2e4749e7eaeae8b5376/flake8-builtins-1.3.0.tar.gz"; sha256 = "ede1673c45ff967aea782231ae4836072a58a5f9db7700cf531995c76ba1734b"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."flake8"
    ...
    "flake8-import-order" = python.mkDerivation {
      ...
      src = pkgs.fetchurl { url = "https://pypi.python.org/packages/ba/50/f8a76dbb07e4bba0d6220fcfb6629206dc52b18d6e984066659b85e63728/flake8-import-order-0.17.1.tar.gz"; sha256 = "68d430781a9ef15c85a0121500cf8462f1a4bc7672acb2a32bfdbcab044ae0b7"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."pycodestyle"
