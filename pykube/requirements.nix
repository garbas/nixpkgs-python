...
#
# COMMAND:
#   pypi2nix -W https://travis.garbas.si/wheels_cache/ -v -V 3.7 -r requirements.txt -O ../overrides.nix
#
...
let
  ...
  generated = self: {
    ...
    "pykube" = python.mkDerivation {
      name = "pykube-0.15.0";
      src = pkgs.fetchurl {
        url = "https://files.pythonhosted.org/packages/a2/40/59fe3425a3d4ac4a41f8d99e71f4862b1c3aaaa99f61afd50ff37f39dae2/pykube-0.15.0.tar.gz";
